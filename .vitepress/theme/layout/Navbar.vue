...
const { theme: themeConfig, ...otherConfigs } = useData()

const mode = useColorMode()
const isDark = computed(() => otherConfigs.isDark.value)
const navlist = computed(() => themeConfig.value.nav)

// change theme
if (localStorage.getItem('vueuse-color-scheme')) {
  mode.value = localStorage.getItem('vueuse-color-scheme') as 'dark' | 'light' || 'light'
      ...
      <ul class="menu menu-horizontal px-1">
        ...
        <li>
          <label class="swap swap-rotate btn btn-ghost">
            ...
            <input type="checkbox" :value="isDark ? 'dark' : 'light'" @click="onToggleTheme" />
